      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                Daksh Kansal
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:dakshkansal03@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f50057' } }}>
                dakshkansal03@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +91 7817849953</Typography>
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()} Daksh Kansal. All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
